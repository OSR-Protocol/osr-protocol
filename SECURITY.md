...
37 tests passing (confirmed 2026-03-23 on devnet). Presale contract deployed to mainnet at `9K1VNBCK6WRDVzYbidG4hH9L3crPXxhqvTBACqM5q8bi`. Token mint: `E2grvu8fyeeuVaxj2DrHVBqv8j21jK3vyJpXG8FJjJNc`. Tests cover: initialization (5), admin actions (9), buy_with_sol with geo attestation (10), buy_with_stablecoin (5), withdrawals (6), close presale (2).
